...
| [#22](https://github.com/VeronicaLourens/vero-perfume/issues/22) Verify email address | As a  registered shopper  | I want to verify my email address so that I can be sure the security of my account and purchase on the site.  | profiles | Must Have |
